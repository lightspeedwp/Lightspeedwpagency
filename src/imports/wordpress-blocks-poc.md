...
## Purpose & Audience
The **WordPress Blocks Proof of Concept** page exists to communicate demonstration of 100% wordpress core block classes with zero tailwind and zero inline styles.
...
**Documentation sections** – introduce the tool or showcase, explain how to use it and link to related resources.
**Interactive demos** – embed live previews or code snippets to demonstrate components.
