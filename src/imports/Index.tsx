import svgPaths from "./svg-rabg3xypr0";
...
type ComponentsButtonLightTextProps = {
  text: string;
};

function ComponentsButtonLightText({ text }: ComponentsButtonLightTextProps) {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center px-[12px] py-[8px] relative rounded-[4px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#090909] border-solid inset-[-0.5px] pointer-events-none rounded-[4.5px]" />
      <div className="flex flex-col font-['Lexend:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#090909] text-[16px] text-center text-nowrap">
...
export default function Index() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center px-0 py-[20px] relative size-full" data-name="Index">
            ...
            <div className="absolute inset-[0_1.13%_0_0]" data-name="Logo Frame">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 158.187 66.7717">
                <g id="Logo Frame">
                  ...
                  <path d={svgPaths.p1602b100} fill="var(--fill-0, black)" id="Vector_2" />
                  ...
                  <path d={svgPaths.p265ea100} fill="var(--fill-0, black)" id="Vector_8" />
      ...
      <div className="content-stretch flex flex-col gap-[50px] items-start justify-center relative shrink-0" data-name="Content">
        <div className="content-stretch flex flex-col gap-[50px] items-start relative shrink-0 w-full" data-name="Template Header">
          ...
          <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 text-black w-full" data-name="Content">
            <p className="font-['Lexend:Medium',sans-serif] font-medium leading-[75px] relative shrink-0 text-[60px] tracking-[-0.02px] w-full">Latest News</p>
            <p className="font-['Manrope:Bold',sans-serif] font-bold leading-[27px] relative shrink-0 text-[20px] tracking-[0.2px] w-full">Description</p>
          </div>
        ...
        <div className="content-stretch flex gap-[10px] items-start relative shrink-0" data-name="Category Selector">
          <ComponentsButtonLightText text="Category 1" />
          <ComponentsButtonLightText text="Category 2" />
          <ComponentsButtonLightText text="Category 3" />
          <ComponentsButtonLightText text="Category 4" />
          <ComponentsButtonLightText text="Category 5" />
        </div>
                ...
                <div className="absolute inset-[0_1.13%_0_0]" data-name="Logo Frame">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 118.64 50.0787">
                    <g id="Logo Frame">
                      ...
                      <path d={svgPaths.p2e911500} fill="var(--fill-0, black)" id="Vector_2" />
                      <path d={svgPaths.p1a944b00} fill="var(--fill-0, black)" id="Vector_3" />
                      <path d={svgPaths.p285b3c80} fill="var(--fill-0, black)" id="Vector_4" />
                      <path d={svgPaths.p24789f00} fill="var(--fill-0, black)" id="Vector_5" />
                      <path d={svgPaths.p1a074000} fill="var(--fill-0, black)" id="Vector_6" />
                      <path d={svgPaths.p351225a0} fill="var(--fill-0, black)" id="Vector_7" />
                      <path d={svgPaths.p26f8ad00} fill="var(--fill-0, black)" id="Vector_8" />
