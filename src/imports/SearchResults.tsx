import svgPaths from "./svg-gas0du2ji5";
...
function Text({ text, additionalClassNames = "" }: TextProps) {
  return (
    <div className={clsx("content-stretch flex items-center relative", additionalClassNames)}>
      <p className="font-['Lexend:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#757575] text-[16px] text-nowrap">{text}</p>
    </div>
  );
}
...
export default function SearchResults() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center px-0 py-[20px] relative size-full" data-name="Search Results">
      ...
      <div className="content-stretch flex flex-col gap-[50px] items-start justify-center pb-[20px] pt-0 px-0 relative shrink-0" data-name="Content">
        <div className="content-stretch flex flex-col gap-[50px] items-start relative shrink-0 w-full" data-name="Template Header">
          ...
          <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Content">
            <p className="font-['Lexend:Medium',sans-serif] font-medium leading-[75px] relative shrink-0 text-[60px] text-black tracking-[-0.02px] w-full">Search results for Search Term</p>
          </div>
        ...
        <div className="content-stretch flex flex-col gap-[5px] items-start justify-center relative shrink-0 w-[620px]" data-name="Search">
          <p className="font-['Lexend:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[16px] text-black text-nowrap">Search Again</p>
          <div className="content-stretch flex gap-[10px] h-[40px] items-center relative shrink-0 w-full" data-name="Components/Search/Search Bar">
            <div className="basis-0 grow h-full min-h-px min-w-px relative rounded-[4px] shrink-0" data-name="Search Input">
              ...
              <div className="flex flex-row items-center size-full">
                <Text text="Placeholder" additionalClassNames="px-[12px] py-[6px] size-full" />
              </div>
            </div>
            <div className="bg-[#1e6aff] content-stretch flex h-full items-center justify-center px-[10px] py-[6px] relative rounded-[4px] shrink-0" data-name="Search Button">
              <HeroiconsOutlineMagnifyingGlass>
                <path d={svgPaths.p2594b100} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
              </HeroiconsOutlineMagnifyingGlass>
            </div>
          </div>
        </div>
        <div className="content-stretch flex flex-col gap-[50px] items-start relative shrink-0 w-[1240px]" data-name="Post Collection">
          {[...Array(3).keys()].map((_, i) => (
            <div className="content-stretch flex gap-[50px] items-start relative shrink-0 w-full" data-name="Row">
              {[...Array(3).keys()].map((_, i) => (
                <div className="basis-0 bg-white grow min-h-px min-w-px relative rounded-[4px] shrink-0" data-name="Components/Blog/Blog Card">
                  <div aria-hidden="true" className="absolute border border-[#757575] border-solid inset-0 pointer-events-none rounded-[4px] shadow-[0px_0px_1px_0px_rgba(9,9,9,0.15),0px_4px_8px_0px_rgba(9,9,9,0.25)]" />
                  <div className="size-full">
                    <div className="content-stretch flex flex-col gap-[20px] items-start p-[20px] relative w-full">
                      <div className="content-stretch flex flex-col gap-[20px] items-start justify-center relative shrink-0 w-full" data-name="Blog Card Body">
                        <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="Container-text">
                          ...
                          <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="Title & Meta">
                            ...
                            <div className="content-start flex flex-wrap gap-[4px] items-start relative shrink-0 w-full" data-name="Blog Card Meta Top">
                              <div className="content-stretch flex items-start relative shrink-0" data-name="Date">
                                <p className="font-['Manrope:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[12px] text-black text-nowrap">Jan 1, 2024</p>
                              </div>
                          ...
                          <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Blog Card Read More">
                    ...
                    <div className="size-full">
                      <div className="content-stretch flex items-start p-[12px] relative w-full">
                        <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px relative self-stretch shrink-0" data-name="Input Contents">
                          <Text text="Enter your email" additionalClassNames="justify-center shrink-0" />
                        </div>
                      </div>
                    </div>
                  </div>
