# Structured Publishing Systems for WordPress

## Purpose & Audience
The **Structured Publishing Systems for WordPress** page exists to communicate we engineer governed wordpress systems — tokenised design, accessible markup, and measurable performance..
...
## Design Brief
Use the **front-page** template with a clear, modular layout.
