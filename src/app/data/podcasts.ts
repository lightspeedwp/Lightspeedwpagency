...
import { podcastCategories, TaxonomyTerm } from './taxonomies';
...
export type PodcastCategory = TaxonomyTerm;
...
export const podcasts: Podcast[] = [
  ...
  },
  {
    ...
    excerpt: 'Ash reflects on two decades of building a WordPress agency — the pivots that worked, the mistakes that taught us, and the principles that have kept <i>LightSpeed</i> growing through every era of the web.',
