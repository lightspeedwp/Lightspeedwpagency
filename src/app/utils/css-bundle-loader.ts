...
export function getBundleForRoute(path: string): CSSBundle | null {
  ...
  const segmentToBundleMap: Record<string, CSSBundle> = {
    ...
    'terms': 'utility',
    'terms-of-service': 'utility',
    'policies': 'utility',
    'policies-publishing-principles': 'utility',
    'policies-diversity-content': 'utility',
    'policies-diversity-staffing': 'utility',
    'policies-ethics': 'utility',
    'policies-feedback': 'utility',
    'policies-corrections': 'utility',
    'policies-ownership-funding': 'utility',
    'getting-started-with-lightspeed': 'utility',
    'mailpoet-unsubscribe-success-page': 'utility',
    'mailpoet-manage-your-subscription': 'utility',
    'mailpoet-unsubscribe-confirmation': 'utility',
    'mailpoet-re-engangement-page': 'utility',
    'styleguide': 'utility',
    'pricing': 'utility',
    ...
    'why-woo': 'utility',
    'why-wp': 'utility',
    'why-mailchimp': 'utility',
    'why-lsx': 'utility',
    'why-lightspeed': 'utility',
    'why-tour-operator': 'utility',
    'website-packages': 'utility',
    'referrals': 'utility',
    'free-consultation': 'utility',
    'free-woo-consultation': 'utility',
    'briefing': 'utility',
    'client-intake-form': 'utility',
    'thank-you-newsletter-subscribe': 'utility',
    'thank-you-for-subscribing': 'utility',
    'thank-you-content-audit-post': 'utility',
    'contact-thank-you': 'utility',
    'free-consultation-thank-you': 'utility',
    'referrals-thank-you': 'utility',
    'client-intake-form-thank-you': 'utility',
    'client-feedback': 'utility',
    'guarantees': 'utility',
