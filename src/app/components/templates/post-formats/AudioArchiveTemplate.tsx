...
import '@/styles/sections/media-grid.css'; // Will create next
        ...
        <Section spacing="lg">
          <Container>
            <header className="mb-12 text-center">
              ...
              <p className="text-xl text-[var(--muted-foreground)]">Listen to our latest interviews and updates.</p>
            </header>
            ...
            <div className="wp-section-media-grid">
              {posts.map((post, index) => (
                <article 
                  key={`${post.id}-${index}`} 
                  className="wp-block-audio-card group"
