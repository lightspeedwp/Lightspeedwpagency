...
import {
  ...
  ChatSquare, ChatCircle, Lock, ShieldCheck,
...
// ============================================
// ICON DATA — Mapping from Lucide to Phosphor
// ============================================
...
const ICON_DATA: IconEntry[] = [
  ...
  { phosphorName: 'ChatSquare', lucideName: 'MessageSquare', component: ChatSquare, category: 'Business', usageCount: 7 },
...
const SAMPLE_ICONS_FOR_COMPARISON = [
