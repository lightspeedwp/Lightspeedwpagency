 ...
 * 
 * WordPress template: templates/page-service-security.html
 * 
 * **Data Source:** `/src/app/data/services.ts` (security-hardening service)
 * 
 * **Pattern Order:**
 * - HeroMinimal (service introduction)
 * - ServicesCard (key features grid)
 * - ProcessTimeline (security process)
 * - TestimonialGrid (client testimonials)
 * - FAQSection (security service FAQs)
...
export function SecurityServiceTemplate() {
  ...
  const service = getServiceBySlug('security-hardening');
