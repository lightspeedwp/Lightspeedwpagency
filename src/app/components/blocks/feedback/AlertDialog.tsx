/**
 * AlertDialog Block Component
 * 
 * WordPress Block: core/group (with alert-dialog variation)
 * Style: .wp-block-alert-dialog
 * 
 * Wraps @radix-ui/react-alert-dialog with WordPress BEM classes.
 * 
 * @see /src/styles/blocks/feedback/modal.css (shares modal base styles)
 */
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ref={ref}
    className={`wp-block-button__link is-style-outline ${className || ''}`}
    {...props}
  />
));
