...
### **3. Architecture** (`/tasks/architecture/`)
...
### **5. Optimization** (`/tasks/optimization/`)
...
### **6. Refactoring** (`/tasks/refactoring/`)
...
2. Create file in `/tasks/[category]/`
...
### **✅ CORRECT: Creating Plans in /tasks/**

```
/tasks/features/2025-01-09-planning-my-feature.md  ← CORRECT
```
...
- [ ] Stored in correct `/tasks/` subdirectory
